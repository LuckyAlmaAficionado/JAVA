...
public class P_login extends javax.swing.JFrame {
    ...
    public boolean Login(){
        ...
        if (jDesktopPane1.isShowing()) {
            ...
            query = "SELECT * FROM tb_account WHERE `username`='"+ loginUsername.getText() +"' AND `password`='"+ loginPassword.getText() +"' ";
        }else{
            System.out.println("Dekstop 2");
            query = "SELECT * FROM tb_account WHERE `username`='"+ registerUsername.getText() +"' AND `password`='"+ registerPassword.getText() +"' ";
        }
        boolean a = false;
        try {
    ...
    public void Register(){
        if (Login()) {
            ...
            try {
                String query = "INSERT INTO `tb_account` (`id`, `username`, `password`) VALUES (NULL, ?, ?)";
                    ...
                    .addGroup(jDesktopPane2Layout.createSequentialGroup()
                        .addGroup(jDesktopPane2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jDesktopPane2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(registerPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(registerConfirmPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
